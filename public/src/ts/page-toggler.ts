;(function () {
   ...
   *     About
   *   </div>
   *   <div class="hidden" data-content="axample">
   *     example
   *   </div>
   * </main>
   */
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const pageTogglerButtons = Array.from(
      document.querySelectorAll<HTMLButtonElement>('button[data-toggle-page]')
    )
    const getPages = () =>
      mainContainer?.querySelectorAll<HTMLDivElement>('[data-content]')
